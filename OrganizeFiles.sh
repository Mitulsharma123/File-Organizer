...
folders='Compressed Documents Images Music Programs Videos Logs'
ext_comp="*.zip *.tar.gz *.xml.gz *tar.xz"
ext_doc="*.htm* *.php *.txt *.css *.doc* *.pdf *.PDF *.ppt* *.js"
ext_img="*.jp*g *.JPG *.png *.gif *.PNG"
ext_music="*.mp3 *.aac *.wma"
ext_progrm="*.deb *.exe *.run"
ext_vid="*.mp4 *.mkv *.flv *.avi *.webm *.wmv *.MOV"
ext_log="*.log *.data *.xlsx *.xls *.csv *.conf"
